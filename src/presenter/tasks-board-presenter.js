...
import Header3Component from "../view/h3-component.js";
...
export default class TaskBoardPresenter {
    ...
    init() {
        ...
        Object.values(Status).forEach(status => {
            ...
            render(new Header3Component(StatusLabel[status]), tasksListComponent.getElement(), RenderPosition.AFTERBEGIN);
            ...
            if (status == 'basket') render(new DeleteButtonComponent(), tasksListComponent.getElement(), RenderPosition.BEFOREEND);
        });
    }
}
